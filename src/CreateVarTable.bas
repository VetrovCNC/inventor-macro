Sub CreateVarTable()
    ...
    oContents(2) = "Лист ОЦ  Б-ПН-3,0 ГОСТ 14918-80/Ст08кп ГОСТ 1050-88"
    oContents(3) = "-"
    ...
    oContents(6) = "Лист Б-ПН-3 ГОСТ 19903-74/Ст3сп ГОСТ 14637-89"
    oContents(7) = "Покрытие: III; У1; в соответствии с заказом."
